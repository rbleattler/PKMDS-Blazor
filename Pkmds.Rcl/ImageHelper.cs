...
/// <summary>
/// Helper class for generating file paths to bundled Pokémon and item sprite images served from
/// <c>_content/Pkmds.Rcl/sprites/</c>. Handles sprite selection based on species, form, gender,
/// context, and other attributes.
/// </summary>
/// <remarks>
/// PokeAPI CDN URL builders (HOME and game-version sprites with full form/gender/Mega/regional
/// coverage) live in <see cref="Pkmds.Core.Utilities.PokeApiSpriteUrls" /> so AOT-clean consumers
/// outside the Blazor stack can share them.
/// </remarks>
